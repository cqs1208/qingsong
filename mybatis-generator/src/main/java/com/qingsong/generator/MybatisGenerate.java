...
//				String className = GenerateUtils.toUpper(cn.substring(0));
				...
				String realProjectPath = projectPath.getPath();

			//	String realProjectPath = projectPath.getPath().substring(0,projectPath.getPath().lastIndexOf("\\"));
			//	realProjectPath += "/bigstudent";

				// 模板文件路径
				String tplPath = "";
				if (db.equals("mysql")) {
					//tplPath = StringUtils.replace(realProjectPath + "/big-student/src/main/java" + "/com/big/student/common/util/generate/template/mysql", "/", separator);
					tplPath = realProjectPath + "/src/main/java/com/bigstudent/common/util/generator/template/mysql";
				} else if (db.equals("oracle")) {
					tplPath = realProjectPath + "/src/main/java/com/bigstudent/common/util/generator/template/oracle";				}

				// Java文件路径,使用
				String dalPath =  StringUtils.replace(realProjectPath + "/src/main/java" + "/com/bigstudent", "/", separator);;
				String bizPath =  StringUtils.replace(realProjectPath + "/src/main/java" + "/com/bigstudent", "/", separator);;
				String webPath =  StringUtils.replace(realProjectPath + "/src/main/java" + "/com/bigstudent", "/", separator);;

				// mybatis文件生成地址
				
				String batisPath = StringUtils.replace(realProjectPath + "/src/main/resources/mappings", "/", separator);
