...
<mapper namespace="${packageName}.dao.${ClassName}Dao">
    ...
    <insert id="saveRecord" parameterType="${packageName}.domain.${ClassName}Do" keyProperty="id">
    ...
    <update id="updateById"  parameterType="${packageName}.domain.${ClassName}Do">
        UPDATE ${tableName}
          <set>
            <#list list as column>
            <#if column.columnName == "id">
	...
	<select id="getById" resultType="${packageName}.domain.${ClassName}Do">
        SELECT
	...
	<select id="getByCommonCondition" resultType="${packageName}.domain.${ClassName}Do" parameterType="${packageName}.domain.${ClassName}Do">
        SELECT
        <include refid="queryFields" />
        FROM ${tableName}
    ...
    <select id="getListByCommonCondition" resultType="${packageName}.domain.${ClassName}Do" parameterType="${packageName}.domain.${ClassName}Do">
        SELECT
        <include refid="queryFields" />
        FROM ${tableName}
        <include refid="commonCondition"/>
